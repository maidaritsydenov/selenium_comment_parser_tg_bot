...
class BotApp:
    ...
    def init(self):
        ...
        dispatcher.add_handler(
            CommandHandler("add_filter", self._callback_add_filter))
        dispatcher.add_handler(
            CommandHandler("show_filters", self._callback_show_filters))
        dispatcher.add_handler(
            CommandHandler("remove_filter", self._callback_remove_filter))
        
        updater.job_queue.run_repeating(
            self._global_timer_add_users_phrases,
            self._JOB_INTERVAL
        )
