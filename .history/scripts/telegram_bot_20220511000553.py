...
class BotApp:
    ...
    def _callback_check_filters(self, bot, message):
        chat_id, user_id = job_data.context
        found_phrases = self._get_phrases_for_user(chat_id, user_id)
        for phrase in found_phrases:
            bot.send_message(chat_id=update.message.chat_id, phrase)
    ...
    def _callback_start(self, bot, update, job_queue):
        ...
        job_queue.run_repeating(
            self._callback_check_filters, 5, context=update.message)
