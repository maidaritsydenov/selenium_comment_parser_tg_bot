...
class _VkChromeClientPipeline(BrowserClientBasePipeline):
    ...
    def _init_output_directories(cls):
        ...
        '''
        makedirs(cls._get_saved_data_dir())
        makedirs(self._get_chrome_profile_data_dir())
    ...
    def _init_browser_parameters(self):
        ...
        chrome_profile_data_dir = self._get_chrome_profile_data_dir()
        makedirs(chrome_profile_data_dir, exist_ok=True)
